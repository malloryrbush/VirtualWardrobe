...
namespace VirtualWardrobeV3.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Name,Photo,Type,Color,Season,Occasion,Size,Price")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Name,Photo,Type,Color,Season,Occasion,Size,Price")] Top top)
        {
            if (ModelState.IsValid)
            {
