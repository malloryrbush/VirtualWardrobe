...
namespace VirtualWardrobeV3.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,Name,Photo,Type,Color,Season,Occasion,Size,Price")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,Name,Photo,Type,Color,Season,Occasion,Size,Price")] Sho sho)
        {
            if (ModelState.IsValid)
            {
