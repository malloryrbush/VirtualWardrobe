...
namespace VirtualWardrobeV3.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Name,Photo,Type,Color,Season,Occasion,Size,Price")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Name,Photo,Type,Color,Season,Occasion,Size,Price")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
