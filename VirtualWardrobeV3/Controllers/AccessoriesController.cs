...
namespace VirtualWardrobeV3.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Name,Photo,Type,Color,Season,Occasion,Size,Price")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Name,Photo,Type,Color,Season,Occasion,Size,Price")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
